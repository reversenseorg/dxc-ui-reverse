...
export class ModelGraphViewerComponent implements OnInit, OnChanges, AfterViewInit {
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes['data'] && !changes['data'].firstChange) {
            ...
            console.log("CFG viewer after datat changes : ",this);
        }
    }
     ...
     */
    private processNode(obj: any, depth: number): string {
        ...
        if (depth < this.maxDepth) {
            this.processRelationships(obj, nodeId, depth);
        }
