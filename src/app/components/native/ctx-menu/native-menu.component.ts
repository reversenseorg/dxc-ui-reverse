...
/*
@Component({
  selector:'dxc-ctxmenu-native',
  template: `
    <app-context-menu [width]="200" [name]="'fn'">
    ...
    <app-context-menu [width]="200" [name]="'sc'">
      <app-context-item [label]="'Show disassembly'" (click)="disass(ctxMenuState.subject)"></app-context-item>
      <app-context-item [label]="'Dump from device'" [disabled]="true" (click)="dumpSection(ctxMenuState.subject)"></app-context-item>
    </app-context-menu>
  `
})
export default class NativeContextMenuesComponent {
